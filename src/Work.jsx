    ...
    <div className="section Work">
      <div className='section-header'>
        ...
        <div className="cards">
          ...
          <Card img={nobelnest} title={"NEPTUNE HOTEL"} desc={"Neptune Hotel is a fictional hotel website"} roles={"Frontend Dev & UX/UI Designer"} tags={[htmli, cssi, reacti]} disable="" url="neptunehotel.netlify.app"/>
